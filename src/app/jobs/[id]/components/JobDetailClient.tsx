        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="ml-4 flex flex-col items-end gap-2">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              {statusSaving && <span className="text-xs text-blue-600 ml-2">Saving…</span>}
            </div>
          </div>
        </div>
        {/* Action Buttons */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="space-y-4">
            {isEditing ? (
              <>
                <input className="w-full border rounded-lg px-3 py-2" placeholder="Salary" value={job.salary || ''} onChange={e => setJob({ ...job, salary: e.target.value })} />
                <input className="w-full border rounded-lg px-3 py-2" placeholder="Job Type (e.g. Full-time)" value={job.jobType || ''} onChange={e => setJob({ ...job, jobType: e.target.value })} />
                <input className="w-full border rounded-lg px-3 py-2" placeholder="Remote (yes/no)" value={job.remote || ''} onChange={e => setJob({ ...job, remote: e.target.value })} />
                <input className="w-full border rounded-lg px-3 py-2" placeholder="Job Link (URL)" value={job.url || ''} onChange={e => setJob({ ...job, url: e.target.value })} />
                <label className="flex items-center gap-2">
                  <input type="checkbox" checked={!!job.easyApply} onChange={e => setJob({ ...job, easyApply: e.target.checked })} />
              ...
              <>
                ...
                {job.jobType && (
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6 6V5a3 3 0 013-3h2a3 3 0 013 3v1h2a2 2 0 002 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011-1h2a1 1 0 011 1v1H8V5zm1 5a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1z" clipRule="evenodd" />
                ...
                {job.url && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Job Link</p>
                      <a href={job.url} className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">{job.url}</a>
                    </div>
                  </div>
                )}
                {job.easyApply && (
